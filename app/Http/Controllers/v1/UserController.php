...
class UserController extends Controller
{
    ...
    public function createTask(Request $request)
    {
        try {
            ...
            $task->status = Task::STATUS_ASSINGNED;
            $task->assign = $request->assign;
            $task->save();

            return $this->returnSuccess('Task created');
        } catch (\Exception $e) {
            return $this->returnError($e->getMessage());
        }
    }
    ...
    /**
     * Update  a task that belongs to the logged user
     *
     * @param Request $request
     * @param $id
     *
    ...
    public function updateTask(Request $request,$id)
    {
        ...
        try {
            ...
            if($task->user_id === $user->id){
              ...
              return  $this->returnError('You are not the owner of this task');
